...
namespace ROMVault.UserControls
{
    internal class FolderBrowserDialog
    {
        ...
        public string SelectedName => SelectedNames.FirstOrDefault();
        ...
        ///
        /// </summary>
        /// <param name="parent">The Parent Form for the dialog (normally, just use 'this')</param>
        /// <returns></returns>
        public bool? ShowDialog(Form parent)
        {
            return ShowDialog(parent.FindForm().Handle);
        }

        internal virtual bool? ShowDialog(IntPtr owner, bool throwOnError = false)
        {
